...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-#_cat)hx-t_^)=el8#74&d&mp1_jhcg!l-^b*55#5()4g39f!w')
...
ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://sosial-media-vdjango-production.up.railway.app']

if RAILWAY_PUBLIC_DOMAIN:
    ALLOWED_HOSTS.append(RAILWAY_PUBLIC_DOMAIN)
else:
    ALLOWED_HOSTS.append('sosial-media-vdjango-production.up.railway.app')
